		...
		<body>
			...
			<div class="container-flud" style="width: %; margin-left: 18%;" >
			 ...
			 <div id="tab1_head">
			   ...
			   <p class="Profile_herader">Staff Details</p>
			   ...
			   <hr style="height:1px; border:none; color:#000; background-color:#000;">
				...
				<div class="row" style="margin-top: -20px;">
				    ...
				    <?php
				    	...
				    	if(isset($this->data["staff_details"])){

				    	foreach ($this->data["staff_details"] as $value) {
				    	   
				    	   echo "<tr>";	
				    	
				    	   echo "<td class='id'>".$value["staff_id_card_no"]."</td>";
						  ...
						  echo '<td>'.anchor('mainPageController/staff_update/'.$value["staff_id_card_no"], 'Edit', ['class'=>'btn btn-primary btn-xs']).'</td>';

				           echo '<td>'.anchor('mainPageController/staff_delete/'.$value["staff_id_card_no"], 'Delete', ['class'=>'btn btn-danger btn-xs']).'</td>';
					...
					foreach ($this->data["staff_details"] as $staff_details) {
