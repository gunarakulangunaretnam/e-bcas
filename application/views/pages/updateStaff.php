...
<html>
		...
		<div class="container">
			 ...
			 <div id="tab1_head" style="margin-top: -80px; position: relative;left: 70px;">
			   ...
			   <hr style="height:1px; border:none; color:#000; background-color:#000;">
					...
					<div id="formSection">
						...
						echo form_open('mainPageController/updateStaffDetails', $attributes); 
						 ...
						 ?>
						 	...
						 	<div class="form-group">
							    ...
							    <div class="col-sm-12 col-xs-11 col-md-5">
							      <input type="text"  name="staff_id" required="true" class="form-control" id="staff_id" placeholder="Enter Student ID">
							    </div>
							</div>
			...
			<script type="text/javascript">
				...
				document.getElementById("staff_id").value=' <?php

							    foreach ($this->data['staff_details_forUpdate']  as $value) {
