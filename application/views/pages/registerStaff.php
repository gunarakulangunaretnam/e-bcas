		...
		<div class="container">
			<div class="row">
			 ...
			 <div id="tab1_head" style="margin-top: -80px; position: relative;left: 70px;">
			   ...
			   <p class="Profile_herader">Staff Registration</p>
			   ...
			   <hr style="height:1px; border:none; color:#000; background-color:#000;">
					...
					<div id="formSection">
						...
						if($this->session->flashdata('successStaff')){
						...
						echo form_open('mainPageController/staffvalidation', $attributes); 

						 ?>

						 	<div class="form-group">
							    <label class="control-label col-sm-2 col-md-5" for="staff_id">Staff ID:</label>
							    <div class="col-sm-12 col-xs-11 col-md-5">
							      <input type="text"  name="staff_id" required="true" class="form-control" id="staff_id" placeholder="Enter Staff ID">
							    </div>
							</div>
							...
							<div class="form-group">
							    <label class="control-label col-sm-2 col-md-5" for="job_title">Job Title:</label>
							    <div class="col-sm-12 col-xs-11 col-md-5">
							      <input type="text" name="job_title" required="true" class="form-control" id="job_title">
							    </div>
							</div>

							<div class="form-group">
							    <label class="control-label col-sm-2 col-md-5" for="job_type">Job Type:</label>
							    <div class="col-sm-12 col-xs-11 col-md-5">
							      <select name="job_type" required="true" class="form-control" id="job_type">
							...
							<div class="form-group">
							    <label class="control-label col-sm-2 col-md-5" for="department">Department :</label>
							    <div class="col-sm-12 col-xs-11 col-md-2">
							    	
							    	    <input list="dep_details" id="department" name="department">

										<datalist id="dep_details">
										 	<?php

										 		foreach ($this->data['dep_ids'] as $value) {
														
													echo '<option value="'.$value['department_id'].'">'.$value['department_full_name']." (".$value['department_short_name'].")".'</option>';
							     ...
							     <div class="col-sm-12 col-xs-11 col-md-5" style="font-size: 16px; font-weight: bold; color: red;" id="department_name"></div>
				...
				window.onload=function(){
					...
					document.getElementById("department").onchange=function(){
						...
						$.ajax({
					      ...
					      url:'<?php echo site_url('mainPageController/derpartmentIDToName')?>', 
					      success:function(result){

					      	document.getElementById("department_name").innerHTML=result;
