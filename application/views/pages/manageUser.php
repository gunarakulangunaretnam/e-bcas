		...
		<body>
			...
			<div class="container-flud" style="width: %; margin-left: 18%;" >
			 ...
			 <div id="tab1_head">
			   ...
			   <p class="Profile_herader">User Account Details</p>
				...
				<div class="row" style="margin-top: -20px;">
				    ...
				    <?php
				    	...
				    	foreach ($this->data["user_details"] as $value) {
				    	   ...
				    	   echo "<td>".$value["student_id_card_no"]."</td>";
				    	   echo "<td>".$value["first_name"].' '.$value["last_name"]."</td>";
				    	   echo "<td>".$value["course_full_title"]."</td>";
				    	   echo "<td>".$value["batch_number"]."</td>";
				    	   echo "<td>".$value["username"]."</td>";
				    	   echo "<td>".$value["password"]."</td>";
				    
				    	  	

						   echo '<td>'.anchor('mainPageController/userUpdateSelection/'.$value["user_id"], 'Edit', ['class'=>'btn btn-primary btn-xs']).'</td>';

				           echo '<td>'.anchor('mainPageController/userDelete/'.$value["user_id"], 'Delete', ['class'=>'btn btn-danger btn-xs']).'</td>';
