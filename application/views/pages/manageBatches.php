		...
		<body>
			...
			<div class="container-flud" style="width: %; margin-left: 18%;" >
			 ...
			 <div id="tab1_head">
			   ...
			   <p class="Profile_herader">Batch Details</p>
			   ...
			   <hr style="height:1px; border:none; color:#000; background-color:#000;">
				...
				<div class="row" style="margin-top: -20px;">
				    ...
				    <?php
				    	...
				    	if(isset($this->data["batch_details"])){

				    	foreach ($this->data["batch_details"] as $value) {
				    	   
				    	   echo "<tr>";	
				    	
				    	   echo "<td class='id'>".$value["batch_number"]."</td>";
				           ...
				           echo '<td>'.anchor('mainPageController/BatchDelete/'.$value["course_id"].'.'.$value['batch_number'], 'Delete', ['class'=>'btn btn-danger btn-xs']).'</td>';
