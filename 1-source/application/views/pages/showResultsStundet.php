		...
		<body>
			...
			<div class="container-flud" style="width: %; margin-left: 18%;" >
			 ...
			 <div id="tab1_head">
			   ...
			   <p class="Profile_herader">My Results</p>
			   ...
			   <hr style="height:1px; border:none; color:#000; background-color:#000;">
				...
				<div class="row" style="margin-top: -20px;">
					...
					<div id="table" class="col-md-12 col-sm-12 col-xs-12">
				       ...
				       <th style="font-weight: bold; font-size: 16px;">Module Name</th>
				       <th style="font-weight: bold; font-size: 16px;">Grade</th>
				       <th style="font-weight: bold; font-size: 16px;">Points</th>
				    ...
				    <?php
				    	...
				    	foreach ($this->data["user_details"] as $value) {
				    	   ...
				    	   echo "<td class='id'>".$value["module_name"]."</td>";
